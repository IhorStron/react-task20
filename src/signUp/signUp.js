   ...
   return (
      <div className={styles.container}>
         <div className={styles.head}>
            <img className={styles.icon} src="https://icons-for-free.com/iconfiles/png/512/lock+locked+padlock+password+protect+protection+security+icon-1320190821382894921.png" alt="lock" />
            <h2>Sign Up</h2>
         </div>
